...
public class FollowingTabActivity extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_following_tab);
        ...
        followersButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent_followers_activity = new Intent(getApplicationContext(),FollowersActivity.class);
        ...
        requestsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent_pending_followers_activity = new Intent(getApplicationContext(), PendingFollowersActivity.class);
